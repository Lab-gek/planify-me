...
public class Services.Database : GLib.Object {
    ...
    construct {
        ...
        table_columns["Items"].add ("points");
    ...
    public void patch_database () {
        ...
        /*
         * Copilot
         * - Add points column to Items
         */
        add_int_column ("Items", "points", 0);
    }
    ...
    public bool insert_item (Objects.Item item) {
        ...
        set_parameter_int (stmt, "$points", item.points);
    ...
    public Objects.Item _fill_item (Sqlite.Statement stmt) {
        ...
        return_value.points = stmt.column_int (23);
    ...
    public bool update_item (Objects.Item item, string update_id = "") {
        ...
        sql = """
            UPDATE Items SET content=$content, description=$description, due=$due,
                ...
                deadline_date=$deadline_date, responsible_uid=$responsible_uid, points=$points
            WHERE id=$id;
        """;
